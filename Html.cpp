...
QString QGI::Html::AttributeAlternate          = "alt";
QString QGI::Html::AttributeCharset            = "charset";
QString QGI::Html::AttributeClass              = "class";
QString QGI::Html::AttributeContent            = "content";
QString QGI::Html::AttributeDescription        = "desciption";
QString QGI::Html::AttributeHeight             = "height";
QString QGI::Html::AttributeHypertextReference = "href";
QString QGI::Html::AttributeHttpEquivalent     = "http-equiv";
QString QGI::Html::AttributeIdentifier         = "id";
QString QGI::Html::AttributeMaximumLength      = "maxlength";
QString QGI::Html::AttributeMedia              = "media";
QString QGI::Html::AttributeName               = "name";
QString QGI::Html::AttributePlaceholder        = "placeholder";
QString QGI::Html::AttributePrefix             = "prefix";
QString QGI::Html::AttributeProperty           = "property";
QString QGI::Html::AttributeRelativity         = "rel";
QString QGI::Html::AttributeSize               = "size";
QString QGI::Html::AttributeSizes              = "sizes";
QString QGI::Html::AttributeSource             = "src";
QString QGI::Html::AttributeStyle              = "style";
QString QGI::Html::AttributeTitle              = "title";
QString QGI::Html::AttributeType               = "type";
QString QGI::Html::AttributeWidth              = "width";
...
QString	QGI::Html::PropertyDisabled            = "disabled";
QString QGI::Html::PropertyReadOnly            = "readonly";
QString QGI::Html::PropertyRequired            = "required";
QString QGI::Html::PropertySelected            = "selected";
